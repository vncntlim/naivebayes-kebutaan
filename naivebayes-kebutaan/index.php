...
<html>
	...
	<body>
		...
		<div class="jumbotron" id="home">
		  	...
		  	<p class="lead">Ini adalah agen kecerdasan buatan sederhana.</p>
		  	<hr class="my-4">
		  	<p class="lead">Agen ini diciptakan untuk mendeteksi kemungkinan kebutaan seorang pasien penderita glukoma.</p>
		</div>
	</body>
</html>