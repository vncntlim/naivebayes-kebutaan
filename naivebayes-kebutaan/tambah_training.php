...
<html>
	...
	<body>
		...
		<div class="container-fluid">
			<hr>
			<h1 class="display-4">Tambah Data Training</h1>
			<hr>
...
<?php
	...
	if(isset($_POST['simpan'])){
		...
		$query = mysqli_query($conn, "INSERT INTO `training` (`NAMA_PASIEN`, `UMUR`, `DIABETES`, `HIPERTENSI`, `INTRAOKULAR`, `KEBUTAAN`) VALUES ('$NAMA_PASIEN', '$UMUR', '$DIABETES', '$HIPERTENSI', '$INTRAOKULAR', '$KEBUTAAN')");
		if($query){
?>
