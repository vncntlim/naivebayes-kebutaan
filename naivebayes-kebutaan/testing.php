...
<?php
	...
	$query = mysqli_query($conn, "SELECT COUNT(*) FROM testing");
...
?>
		...
		<div class="container-fluid">
			<hr>
			<h1 class="display-4">Data Testing</h1>
			<hr>
			<div class="row">
				<div class="col-12 col-md-8">
					<a href="testing_baru.php" class="btn btn-primary">Test Data Baru</a>
				</div>
...
<?php
	$i = $halaman * 10 - 9;
	$query = mysqli_query($conn, "SELECT * FROM testing LIMIT $offset, $banyak_data_per_halaman");
	while($testing = mysqli_fetch_assoc($query)){
?>
				<tr>
					<th scope="row"><?php echo $i; ?></th>
					<td><?php echo $testing['NAMA_PASIEN']; ?></td>
					<td><?php echo $testing['UMUR']; ?></td>
					<td><?php echo $testing['DIABETES']; ?></td>
					<td><?php echo $testing['HIPERTENSI']; ?></td>
					<td><?php echo $testing['INTRAOKULAR']; ?></td>
					<td><?php echo $testing['KEBUTAAN']; ?></td>
					<td><a href="detail_testing.php?detail=<?php echo $testing['NOMOR']; ?>" class="btn btn-default">Detail</a></td>
					<td><a href="hapus_testing.php?hapus=<?php echo $testing['NOMOR']; ?>" class="btn btn-default" onclick="return confirm('Anda yakin akan menghapus data <?php echo $testing['NAMA_PASIEN'];?> ?')">Hapus</a></td>
				</tr>
<?php
		$i++;
	}
